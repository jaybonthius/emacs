;;; navigation.el --- File navigation, sessions, and buffer management -*- lexical-binding: t; -*-
;;; Commentary:
;; File navigation, project management, buffer management, and session handling
;;; Code:
...
(use-package easysession
  ...
  ;; session is loaded after all other packages.
...
;; layout, similar to file browsers in modern IDEs.
...
(use-package auto-package-update
  ...
  ;; Automatically delete old package versions after updates to reduce disk usage.
